...
app.meteora.ag в один клик: сумма в SOL и диапазон в процентах.
...
5. Открыть любой DLMM-пул: `https://app.meteora.ag/dlmm/<адрес пула>`
...
- **⚙** — пресеты, стратегия, отключение автонажатия.
- **▾** — свернуть панель.
